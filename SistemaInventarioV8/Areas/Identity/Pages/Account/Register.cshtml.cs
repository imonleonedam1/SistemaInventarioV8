...
namespace SistemaInventarioV8.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirmacion correo",
                        $"Confirma tu email haciendo clicl <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>aqui</a>.");
