    ...
    public class InventarioController : Controller
    {
        ...
        public async Task<IActionResult> GenerarStock(int id)
        {
            ...
            foreach (var item in detalleLista)
            {
                ...
                if (bodegaProducto != null) // el registro existe
                {
        ...
        public async Task<IActionResult> BuscarProducto(string term)
        {
            ...
            {
                var lista = await _unidadTrabajo.Producto.ObtenerTodos(p => p.Estado == true);
                var data = lista.Where(x => x.NumeroSerie.Contains(term, StringComparison.OrdinalIgnoreCase) ||
